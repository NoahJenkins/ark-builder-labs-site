...
export function ServicesPageContent() {
  return (
    <div className="min-h-screen bg-background">
      <section
        aria-label="Service blueprint overview"
      ...
      >
        ...
        <div className="container relative mx-auto px-4 py-12 md:py-20 lg:py-28">
          <div className="grid gap-8 md:gap-12 xl:grid-cols-[0.72fr_1.28fr] xl:items-start">
            <FadeIn direction="up" className="max-w-2xl pt-2 lg:pl-20 xl:pl-16">
              <p className="mb-5 text-xs font-semibold uppercase tracking-[0.22em] text-primary md:mb-8">
                Services
              </p>
              <h1 className="max-w-[10ch] font-[family-name:var(--font-ledger)] text-4xl font-semibold leading-[1.04] tracking-normal text-foreground sm:text-5xl md:text-6xl xl:text-7xl">
                Services built with stewardship
              </h1>
              <div className="mt-5 h-1 w-20 rounded-full bg-[var(--field-amber)] md:mt-7 md:w-24" />
              <p className="mt-5 max-w-xl text-base leading-7 text-muted-foreground md:mt-7 md:text-xl md:leading-8">
              ...
              <div className="overflow-hidden rounded-xl border border-border bg-card/90 shadow-sm">
                ...
                <div className="grid gap-0 lg:grid-cols-[0.95fr_1.05fr]">
                  <div className="border-b border-border p-5 md:p-6 lg:border-b-0 lg:border-r">
                    <p className="mb-3 font-mono text-xs uppercase tracking-[0.16em] text-primary md:mb-4">
                      Technical Blueprint
                    </p>
                    <h2 className="font-[family-name:var(--font-ledger)] text-2xl font-semibold leading-tight text-foreground md:text-4xl">
                      Three service paths, one operating posture.
                    </h2>
                    <p className="mt-4 text-sm leading-7 text-muted-foreground md:mt-5">
                  ...
                  <div className="p-5 md:p-6">
                    ...
                    <div className="mt-6 rounded-lg border border-[var(--ledger-line)] bg-background p-4 md:mt-8">
      ...
      <section
        ...
        className="relative overflow-hidden border-b border-[oklch(95%_0.008_85_/_0.12)] bg-[var(--deep-navy)] py-12 text-[oklch(95%_0.008_85)] md:py-20 lg:py-24"
      >
                ...
                {SERVICES.map((service, index) => {
                  ...
                  return (
                    <article
                      ...
                      className="group relative grid gap-4 border-b border-[oklch(95%_0.008_85_/_0.14)] p-4 last:border-b-0 sm:p-6 md:gap-5 lg:grid-cols-[84px_minmax(220px,0.9fr)_minmax(290px,1.1fr)_150px] lg:items-start"
                    >
                      ...
                      <div>
                        ...
                        <h3 className="max-w-[16rem] text-xl font-semibold leading-tight text-[oklch(95%_0.008_85)] md:text-[1.35rem] lg:max-w-[13rem]">
                          {service.title}
                        </h3>
      ...
      <section
        ...
        className="relative overflow-hidden bg-[var(--paper-warm)] py-14 text-foreground md:py-20"
      >
        <div className="absolute inset-0 about-ledger-grid opacity-45" />
        <div className="container relative mx-auto px-4">
          <div className="grid gap-10 lg:grid-cols-[0.8fr_1.2fr] lg:items-center">
            <FadeIn direction="up" className="lg:pl-20">
              ...
              <h2 className="max-w-xl font-[family-name:var(--font-ledger)] text-4xl font-semibold leading-tight text-foreground md:text-5xl">
            ...
            <FadeIn direction="up" delay={0.1}>
              <div className="rounded-xl border border-border bg-card/92 p-5 shadow-sm md:p-6">
